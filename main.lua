...
local Window = Fluent:CreateWindow({
    Title = "Erader Hub",
    SubTitle = "https://discord.gg/yQjekwtWrS",
    TabWidth = 160,
...
Tabs.Info:AddParagraph({
    ...
    Content = "Join My Discord For Update",
})
Tabs.Info:AddButton({
    Title = "Click To Coppy Link Discord",
                            ...
                            for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                ...
                                elseif string.find(v.Name,"kissed Warrior") == nil then
                                    ...
                                    if game:GetService("ReplicatedStorage"):FindFirstChild(Mon) then
                                        TP("Tween", game:GetService("ReplicatedStorage"):FindFirstChild(Mon).HumanoidRootPart.CFrame * CFrame.new(0,20,0))
                                    end
                                end
                            end
                        else
